...
def main(cfg):
    ...
    task_file = f'{ISAAC_ROOT_DIR}/tasks/factory/{env_name}.py'
    task_obs_file = f'{EUREKA_ROOT_DIR}/envs/isaac/{env_name}_obs.py'
    shutil.copy(task_obs_file, f"env_init_obs.py")
    task_code_string = file_to_string(task_file)
    task_obs_code_string = file_to_string(task_obs_file)
    output_file = f"{ISAAC_ROOT_DIR}/tasks/factory/{env_name}{suffix.lower()}.py"
